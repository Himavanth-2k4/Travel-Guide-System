                                ...
                                <div class="booking-details">
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-info">
                                            <h4>Travelers</h4>
                                            <p><?php echo $trip['num_travelers']; ?> Persons</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-info">
                                            <h4>Accommodation</h4>
                                            <p><?php echo ucfirst($trip['accommodation_type']); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-info">
                                            ...
                                            <p><?php echo ucfirst($trip['transportation_type']); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-info">
                                            <h4>Budget Range</h4>
                                            <p><?php echo ucfirst($trip['budget_range']); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if($trip['activities'] || $trip['special_requirements']): ?>
                                    <div class="booking-notes">
                                        <?php if($trip['activities']): ?>
                                            ...
                                            <p><?php echo htmlspecialchars($trip['activities']); ?></p>
                                        <?php endif; ?>
                                        ...
                                        <?php if($trip['special_requirements']): ?>
                                            ...
                                            <p><?php echo htmlspecialchars($trip['special_requirements']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
