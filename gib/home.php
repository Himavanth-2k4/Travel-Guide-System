...
<header class="site-header">
    ...
    <section class="hero-section">
        ...
        <div class="container">
            <h1 class="hero-title">Discover Incredible <span>India</span></h1>
            <p class="hero-subtitle">
                Explore the rich culture, vibrant traditions, breathtaking landscapes, and ancient heritage of India.
            </p>
            ...
            <div class="search-container">
                <form action="search-results.php" method="GET" class="search-form">
                    <input 
                        type="text" 
                        name="query" 
                        placeholder="Search for destinations, experiences, or cities..." 
                        class="search-input"
                    >
                ...
                <div class="search-tags">
                    <span class="search-tag">#TajMahal</span>
                    <span class="search-tag">#Kerala</span>
                    <span class="search-tag">#Varanasi</span>
                    <span class="search-tag">#Rajasthan</span>
                    <span class="search-tag">#Himalayas</span>
                </div>
            </div>
            
           <!-- Stats -->
<div class="hero-stats">
    <a href="29+states.php" class="stat-box">
        <div class="stat-number">29+</div>
        <div class="stat-label">States</div>
    </a>
    <a href="languages.php" class="stat-box">
        <div class="stat-number">22+</div>
        <div class="stat-label">Languages</div>
    </a>
    <a href="heritage.php" class="stat-box">
        <div class="stat-number">40+</div>
        <div class="stat-label">World Heritage Sites</div>
    </a>
    <a href="history.php" class="stat-box">
        ...
        <div class="container">
            <div class="section-header">
                <div>
                    ...
                    <p class="section-subtitle">India offers a kaleidoscope of experiences that captivate all your senses</p>
                </div>
            </div>
            ...
            <div class="features-grid">
                <div class="feature-box">
                    ...
                    <h3 class="feature-title">Diverse Culture</h3>
                    <p class="feature-text">Experience the rich tapestry of diverse cultures, languages, and traditions across different states.</p>
                </div>
                ...
                <div class="feature-box">
                    ...
                    <h3 class="feature-title">Exquisite Cuisine</h3>
                    <p class="feature-text">Savor a variety of delicious regional cuisines, spices, and flavors unique to each part of India.</p>
                </div>
                ...
                <div class="feature-box">
                    ...
                    <h3 class="feature-title">Rich History</h3>
                    <p class="feature-text">Explore ancient temples, magnificent forts, and historical monuments that tell stories of India's glorious past.</p>
                </div>
                ...
                <div class="feature-box">
                    ...
                    <h3 class="feature-title">Diverse Landscapes</h3>
                    <p class="feature-text">From snow-capped mountains to sun-kissed beaches, dense forests to vast deserts, India has it all.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="destinations-section">
    <div class="container">
        ...
        <?php include 'destinations_data.php'; ?>
        
        <div class="section-header">
            <div>
                <h2 class="section-title">Popular Destinations</h2>
                <p class="section-subtitle">
                    Discover the most visited and loved destinations across India
                </p>
            </div>
        ...
        <div class="destinations-grid">
            <?php
            // Include the card rendering function
            include 'destination_card.php';
            


// Display one destination from each category

$categories = ['Heritage', 'Nature', 'Spiritual', 'Adventure', 'Beach'];
foreach ($categories as $category) {
    $category_destinations = array_filter($destinations, function($dest) use ($category) {
        return $dest['category'] === $category;
    });
    
    // Display all destinations in this category
    foreach ($category_destinations as $destination) {
    ...
    <section class="booking-section">
        ...
        <div class="container">
            <div class="section-header" style="text-align: center; display: block;">
                <h2 class="section-title" style="display: block; text-align: center;">Plan Your Perfect Indian Journey</h2>
                <p class="section-subtitle" style="display: block; max-width: 700px; margin: 1rem auto 0;">
                    Customize your experience with our guided tours, accommodation options, and transportation services.
                </p>
            </div>
                ...
                <div class="booking-tabs">
                    <div class="tabs-header">
                        <button class="tab-btn active" data-tab="tours">
                            <i class="fas fa-route"></i> Guided Tours
                        </button>
                    ...
                    <div class="tabs-content">
                        <!-- Tours Tab -->
                        <div class="tab-pane active" id="tours-tab">
                            <form action="search-tours.php" method="GET" class="booking-form">
                        ...
                        <!-- Hotels Tab (hidden by default) -->
                        <div class="tab-pane" id="hotels-tab" style="display: none;">
                            <form action="search-hotels.php" method="GET" class="booking-form">
                                <div class="form-group">
                                    <label for="hotel-destination">Destination</label>
                                    <div class="input-icon">
                                        <i class="fas fa-map-marker-alt icon"></i>
                                        <input type="text" id="hotel-destination" name="destination" placeholder="Where do you need a hotel?">
                                    </div>
                                </div>
                        ...
                        <!-- Transport Tab (hidden by default) -->
                        <div class="tab-pane" id="transport-tab" style="display: none;">
                            <form action="search-transport.php" method="GET" class="booking-form">
                                <div class="form-row">
                                    <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input type="date" id="travel-date" name="date">
                                        </div>
                                    </div>
            ...
            <div class="packages-grid">
                <div class="package-card">
                    ...
                    <h3 class="package-title">Golden Triangle</h3>
                    <p class="package-description">
                        Explore Delhi, Agra, and Jaipur on this classic 6-day cultural tour.
                    </p>
                    <p class="package-price">From ₹25,000</p>
                    <a href="package-details.php?id=1" class="btn btn-outline">View Details</a>
                </div>
                
                <div class="package-card">
                    <div class="package-icon">🏝️</div>
                    <h3 class="package-title">Kerala Experience</h3>
                    <p class="package-description">
                        Discover backwaters, beaches, and Ayurveda in God's Own Country.
                    </p>
                    <p class="package-price">From ₹35,000</p>
                    <a href="package-details.php?id=2" class="btn btn-outline">View Details</a>
                </div>
                
                <div class="package-card">
                    <div class="package-icon">🏔️</div>
                    <h3 class="package-title">Himalayan Adventure</h3>
                    <p class="package-description">
                        Trekking, camping, and exploring mountain cultures in the Himalayas.
                    </p>
                    <p class="package-price">From ₹45,000</p>
                    <a href="package-details.php?id=3" class="btn btn-outline">View Details</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="testimonials-section">
        <div class="container">
            <div class="section-header" style="text-align: center; display: block;">
                <h2 class="section-title" style="display: block; text-align: center;">Our Happy Travelers</h2>
                <p class="section-subtitle" style="display: block; max-width: 700px; margin: 1rem auto 0;">
                    Read what our customers have to say about their incredible journeys through India
                </p>
            </div>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <p class="testimonial-content">
                        "The Golden Triangle tour was absolutely amazing! Our guide was knowledgeable and the accommodations were perfect. The Taj Mahal at sunrise is something I will never forget."
                    </p>
                    <div class="testimonial-author">
                        <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Sarah Johnson" class="author-avatar">
                ...
                <div class="testimonial-card">
                    <p class="testimonial-content">
                        "Kerala backwaters exceeded my expectations. The houseboat stay was so peaceful and the local food prepared by the crew was delicious. A truly authentic experience!"
                    </p>
                    <div class="testimonial-author">
                        <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="David Miller" class="author-avatar">
                        <div class="author-info">
                            <h4>David Miller</h4>
                            <p>Australia</p>
                        </div>
                ...
                <div class="testimonial-card">
                    <p class="testimonial-content">
                        "HOVI & JAVI organized a perfect Himalayan adventure for us. The trekking routes were challenging but rewarding with breathtaking views. The local guides knew all the hidden spots."
                    </p>
                    <div class="testimonial-author">
                        <img src="https://randomuser.me/api/portraits/women/32.jpg" alt="Emma Wilson" class="author-avatar">
                        <div class="author-info">
                            <h4>Emma Wilson</h4>
                            <p>United Kingdom</p>
                        </div>
